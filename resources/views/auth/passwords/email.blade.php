...
@section('content')
    ...
    <div class="app-cam">
        ...
        <form class="form-horizontal" role="form" method="POST" action="{{ action('HomeController@sendmail') }}" name="forgetPassword">
            ...
            <div class="submit"><button type="submit" class="forgotpassword-button btn btn-primary">Send Reset Email</button>&nbsp;&nbsp;<button type="button" class="forgotpassword-button btn btn-primary" onclick="window.history.back();">Back</button></div>           
        </form>
        <br><br>
