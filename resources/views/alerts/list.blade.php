            ...
            <script type="text/javascript">
                $(document).ready(function(){
                    ...
                    $("#alert").on("click", ".clickable-row", function() {
                        ...
                        if(filename !='' && $.inArray(ext, ['txt','csv']) != -1){
                            $('#file').html('<a href="'+urlbase+'/alerts/download/'+id+'">Download</a>');
                        }
                    ...
                    $(document).on('change','.alert_checkbox',function(){
                    ...
                    $(document).on('change','.alert_checkbox_all',function(){
                        if ($(this).is(':checked')) {
