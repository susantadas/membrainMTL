						...
						jQuery('#fileuploader').uploadFile({
							...
							onSuccess : function(files,data,xhr) {
								if(data.notformeted == 0){
									...
									jQuery('#massage').html('<ul class="error-success"><li class="errors">Salacious Words csv data does not contain properly formatted Salacious Words patterns</li></ul>').show();
								}
							},
						});
					});
