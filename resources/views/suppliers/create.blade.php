        ...
        <div class="xs">
            ...
            <div class="well1 white">
                            ...
                            <div class="col-sm-6">
                                <label class="control-label">&nbsp;</label>
                                  <div class="checkboxb checkbox-primary">
                                    <input id="return_csv" name="return_csv" type="checkbox" value="0" />
                ...
                <script type="text/javascript">
                    ...
                    /* End active/inactive */
                    /* Start return csv ctive/inactive */
                    jQuery(document).on('click','#return_csv',function(){
                        if(jQuery(this).is(':checked')==true){
                            jQuery(this).attr('checked','checked');
                            jQuery(this).val('1');
                        } else {
                    ...
                    /* End return csv active/inactive */
                    /* Start reset */
                    jQuery("button[type=reset]").click(function(){
                        jQuery("#active").attr("checked",false);
                        jQuery('#active').val('0');
                        jQuery("#return_csv").attr("checked",false);
                        jQuery('#return_csv').val('0');
                    });
                    /* End reset */
                </script>
            </div>
