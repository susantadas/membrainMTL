            ...
            <div class="well1 white">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group filled">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="hidden" name="tmp_client_id_email" id="tmp_client_id_email" value="{{ $client->id }}" />
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <input type="hidden" name="tmp_client_id_phone" id="tmp_client_id_phone" value="{{ $client->id }}" />
                        ...
                        <div class="form-group">
                             <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="current_email_suppression" name="current_email_suppression" value="{{$client->ce_suppression}}" readonly="readonly" disabled="disabled" />
                            </div>
                            <div class="col-sm-6">
                                <label class="control-label">Current Phone Suppression</label>
                                <input type="text" class="form-control1 ng-invalid ng-invalid-required ng-touched" id="current_phone_suppression" name="current_phone_suppression" value="{{$client->cp_suppression}}" readonly="readonly" disabled="disabled" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-12">                           
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <button type="submit" id="saveButtonClient" class="btn btn-primary">Save Changes</button>
                ...
                <script type="text/javascript">
                    $(document).ready(function() {
                        ...
                        $('#lead_expiry_days').focusout(function(){
                            ...
                            if($(this).val()=='') {
                                ...
                                $("#lead_expiry_days-error").text('Please enter numeric value');
                                jQuery("button[type=submit]").prop("disabled",true);
                            } else if($(this).val().length < '2' || $(this).val().length > '3' ) {
                                $("#lead_expiry_days-error").text('Please enter min 2 or max 3 digits');
                                jQuery("button[type=submit]").prop("disabled",true);                            
                            } else {
                    ...
                    jQuery(document).on('click','#saveButtonClient',function(){
                        ...
                        if($('#lead_expiry_days-error').text()!='' || $('#lead_expiry_days').val()=='' || $('#lead_expiry_days').val().length < '2' || $('#lead_expiry_days').val().length > '3' ){
                            $("#lead_expiry_days-error").text('Please enter Lead Expiry Days');
                            valid = 1;
                        }
                        ...
                        if(valid==0){
                            jQuery.ajax({
                                url: "{{ action('ClientsController@update',$client->id) }}",
                                type: 'POST',
                                data: {'_token':'{{ csrf_token() }}','_method':'PUT','name':$('#name').val(),'contact_email':$('#contact_email').val(),'contact_name':$('#contact_name').val(),'contact_phone':$('#contact_phone').val(),'country_code':$('#country_code').val(),'lead_expiry_days':$('#lead_expiry_days').val(),'tmp_client_id_email':$('#tmp_client_id_email').val(),'tmp_client_id_phone':$('#tmp_client_id_phone').val(),'active':$('#active').val()},
                                beforeSend:function(){
                                    jQuery("button[type=submit]").prop("disabled",true);
                                },
                    ...
                    jQuery(document).ready(function() {
                        jQuery('#fileuploader1').uploadFile({
                            ...
                            dynamicFormData:function(){
                                var data = {'country_code':$('#country_code').val(),'tmp_client_id_phone':$('#tmp_client_id_phone').val()};
                                return data;
                            },
                            onSuccess : function(files,data,xhr) {
                                if(data.status==1){
                                    ...
                                    jQuery('#massage-phone').html(data.error).css('color','red');
                                } else {
                                    jQuery('#massage-phone').html(' CSV does not contain properly formatted phone numbers').css('color','red');
                                }
                            },
                        });
                        ...
                        jQuery('#fileuploader').uploadFile({
                            ...
                            //maxFileCount:1,
                            dynamicFormData:function(){
                                var data = {'tmp_client_id_email':$('#tmp_client_id_email').val()};
                                return data;
                            },
                            onSuccess : function(files,data,xhr) {
                                if(data.status==1){
                                    ...
                                    jQuery('#massage-email').html('CSV does not contain properly formatted emails').css('color','red');
                                }
                            },
                        });
                    });
