      ...
      <div class="well1 white">
        ...
        <script type="text/javascript">
          jQuery(function() {
            ...
            },$.validator.format("Please enter a valid input."));
            ...
            $.validator.addMethod("notEqualToGroupApi", function (value, element, options) {
            ...
            }, $.validator.format("Please enter a diferent value"));
            ...
            jQuery("form[name='campaignCreate']").validate({
              rules: {
                ...
                email:{ notEqualToGroupApi: ['.unique-api'] },
                phone:{ notEqualToGroupApi: ['.unique-api'] },  
                title:{ notEqualToGroupApi: ['.unique-api'] },
                firstName:{ notEqualToGroupApi: ['.unique-api'] },
                lastName:{ notEqualToGroupApi: ['.unique-api'] },
                birthdate:{ notEqualToGroupApi: ['.unique-api'] },
                age:{ notEqualToGroupApi: ['.unique-api'] },
                ageRange:{ notEqualToGroupApi: ['.unique-api'] },
                gender:{ notEqualToGroupApi: ['.unique-api'] },
                address1:{ notEqualToGroupApi: ['.unique-api'] },
                address2:{ notEqualToGroupApi: ['.unique-api'] },
                city:{ notEqualToGroupApi: ['.unique-api'] },
                state:{ notEqualToGroupApi: ['.unique-api'] },
                postcode:{ notEqualToGroupApi: ['.unique-api'] },
                countryCode:{ notEqualToGroupApi: ['.unique-api'] },
                server_type:{
