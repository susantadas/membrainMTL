...
class ClientstestUpdate extends TestCase
{
    ...
    public function test_for_existing_email(){
        $data =  array('name'=>'Susanta','contact_email'=>'rakim46@gmail.com','contact_name'=>'Susanta Kumar Das','contact_phone'=>'9638527410','country_code'=>'AU','lead_expiry_days'=>'90','active'=>'1','email_suppression'=>'0','phone_suppression'=>'0');
        $uservalidation = new Uservalidation;
        $validator = Validator::make($data, Uservalidation::$rules);
        if($validator->fails()){
    ...
    public function test_for_existing_phone(){
        $data =  array('name'=>'Susanta','contact_email'=>'rakim46@gmail.com','contact_name'=>'Susanta Kumar Das','contact_phone'=>'9966666669','country_code'=>'AU','lead_expiry_days'=>'90','active'=>'1','email_suppression'=>'0','phone_suppression'=>'0');
        $uservalidation = new Uservalidation;
        $validator = Validator::make($data, Uservalidation::$rules);        
        if($validator->fails()){
    ...
    public function test_create_supplier(){
        $data = array('name'=>'Susanta','contact_email'=>'isusantakumardasnew@gmail.com','contact_name'=>'Susanta kumar Das','contact_phone'=>'9638527411','country_code'=>'AU','lead_expiry_days'=>'90','active'=>'1','email_suppression'=>'0','phone_suppression'=>'0');
        $uservalidation = new Uservalidation;
        $validator = Validator::make($data, Uservalidation::$rules);  
        $check = $validator->passes();
        $this->assertTrue($check);
        /*if($check == 1){
            $clicent = Client::where('id','3')->update($data);
            $this->assertTrue($clicent);
