...
class SupplierstestUpdate extends TestCase
{
    ...
    public function test_create_supplier(){
        $data =  array('public_id'=>hash('md5', 'MB#'.rand(1111111111,9999999999)),'name'=>'Susanta','contact_email'=>'isusantakumardasnew1@gmail.com','contact_name'=>'Susanta Kumar Das','contact_phone'=>'12345678921','error_allowance'=>'10','return_csv'=>'1','active'=>'1');
        $uservalidation = new Uservalidation;
        $validator = Validator::make($data, Uservalidation::$rules);  
