...
class QuarantinesController extends Controller
{
    ...
    public function store(Request $request) {
        $path = storage_path().'/qurantine-file/' .$request->input('id');
    ...
    public function destroy($quarantines) {
        ...
        if(!$quarantine->save()){
            ...
            $path = storage_path().'/qurantine-file/'.$id;
            \File::cleanDirectory($path);
    ...
    public function downloadExcelFile($quarantines){
        ...
        if($quarantine->filename !=''){
            $file= storage_path(). '/qurantine-file/'.$quarantine->id.'/'.$quarantine->filename;
            $headers = array(
